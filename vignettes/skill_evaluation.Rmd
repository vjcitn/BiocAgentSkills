...
conventions and multi-step workflows.  The value of a skill document depends on
the code it elicits, which itself will depend on the user's prompt and
the model in use.  If a model ignores the document, uses a deprecated function, or
